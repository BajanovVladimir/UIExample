...
public class AddContactForm extends JFrame {
    ...
    private final JTextField textFieldPhoneNumber;
    private final JTextField textFieldPosition;
    private final JTextField textFieldPerson;
    ...
    AddContactForm(OrganizationsRepository organization, String organizationName, JComboBox comboBox) {
        ...
        JButton saveContactButton = new JButton("Сохранить");
    ...
    private  class  SaveContactButtonPressed implements ActionListener {
        private final JFrame contactFrame;
